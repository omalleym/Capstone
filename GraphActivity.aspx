<%@ Page Title="" Language="C#" MasterPageFile="MasterPage.master" AutoEventWireup="true" CodeFile="GraphActivity.aspx.cs" Inherits="GraphActivity" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <img src = "http://i.imgur.com/rNJvXlQ.png" />

     <table align="center" style="width:300px">
<tr>
  <td><div id="contentBernie">
      
      <%--<script type="text/javascript">
          document.body.onload = init();
    </script>--%>

        <p><b>Let's finish graphing the rest of this model. Drag points A through M to their appropriate places on the graph, starting with point A.</b></p>
        <table border="1">
            <tr>
                <td>
...
<tr>
  <td>
    ...
    <img src ="http://i.imgur.com/ysGc94S.png" />
