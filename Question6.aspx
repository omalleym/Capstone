...
<script type="text/javascript" src="http://ajax.googleapis.com/ajax/libs/jqueryui/1.8.9/jquery-ui.min.js"></script>
    ...
    <script type="text/javascript">
        function init() {
            ...
            for (var i = 0; i < 1; i++) {
                $('<div>' + 'M' + '</div>').data('number', 25).attr('id', 'point' + row1Points[i]).appendTo('#graphPoints1').draggable({
                    containment: '#content',
            ...
            for (var i = 0; i < 2; i++) {
                if (i == 0) {
                    $('<div>' + 'K' + '</div>').data('number', 21).attr('id', 'point' + row2Points[i]).appendTo('#graphPoints2').draggable({
                        containment: '#content',
                ...
                if (i == 1) {
                    $('<div>' + 'L' + '</div>').data('number', 23).attr('id', 'point' + row2Points[i]).appendTo('#graphPoints2').draggable({
                        containment: '#content',
                        stack: '#graphPoints2 div',
                        cursor: 'move',
                        revert: true
            ...
            for (var i = 0; i < 1; i++) {
                $('<div>' + 'J' + '</div>').data('number', 19).attr('id', 'point' + row3Points[i]).appendTo('#graphPoints3').draggable({
                    containment: '#content',
            ...
            for (var i = 0; i < 1; i++) {
                $('<div>' + 'I' + '</div>').data('number', 17).attr('id', 'point' + row5Points[i]).appendTo('#graphPoints5').draggable({
                    containment: '#content',
            ...
            for (var i = 0; i < 1; i++) {
                $('<div>' + 'H' + '</div>').data('number', 15).attr('id', 'point' + row9Points[i]).appendTo('#graphPoints9').draggable({
                    containment: '#content',
            ...
            for (var i = 0; i < 1; i++) {
                $('<div>' + 'F' + '</div>').data('number', 11).attr('id', 'point' + row16Points[i]).appendTo('#graphPoints16').draggable({
                    containment: '#content',
            ...
            for (var i = 0; i < 1; i++) {
                $('<div>' + 'E' + '</div>').data('number', 9).attr('id', 'point' + row19Points[i]).appendTo('#graphPoints19').draggable({
                    containment: '#content',
            ...
            for (var i = 0; i < 1; i++) {
                $('<div>' + 'D' + '</div>').data('number', 7).attr('id', 'point' + row20Points[i]).appendTo('#graphPoints20').draggable({
                    containment: '#content',
            ...
            for (var i = 0; i < 3; i++) {
                if (i == 0) {
                    $('<div>' + 'A' + '</div>').data('number', 1).attr('id', 'point' + row21Points[i]).appendTo('#graphPoints21').draggable({
                        containment: '#content',
                ...
                if (i == 1) {
                    $('<div>' + 'B' + '</div>').data('number', 3).attr('id', 'point' + row21Points[i]).appendTo('#graphPoints21').draggable({
                        containment: '#content',
                        stack: '#graphPoints21 div',
                        cursor: 'move',
                        revert: true
                ...
                if (i == 1) {
                    $('<div>' + 'C' + '</div>').data('number', 5).attr('id', 'point' + row21Points[i]).appendTo('#graphPoints21').draggable({
                        containment: '#content',
                        stack: '#graphPoints21 div',
                        cursor: 'move',
                        revert: true
            ...
            <tr>
                <td>
                    <div id="graphColumnLeft">
                        <asp:Image ID="plotPointTable" runat="server" ImageUrl="samp.jpg" /></div>
                </td>
                <td>
                    <div id="yaxis"></div>
